...
python3 preprocess.py $results $PREPROCESSED
echo "DONE."

echo "PLOTTING CUMULATIVE TIME $PREPROCESSED INTO $CUMULATIVE_TIME"
python3 gen-plot.py $PREPROCESSED time > $CUMULATIVE_TIME
echo "DONE."

echo "PLOTTING CUMULATIVE MEMORY $PREPROCESSED INTO $CUMULATIVE_MEMORY"
python3 gen-plot.py $PREPROCESSED memory > $CUMULATIVE_MEMORY
echo "DONE."